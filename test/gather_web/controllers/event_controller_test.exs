defmodule GatherWeb.EventControllerTest do
  use GatherWeb.ConnCase

  alias Gather.Events

  @create_attrs %{address: "some address", link: "some link", name: "some name", region: "some region", summary: "some summary", time: ~N[2010-04-17 14:00:00]}
